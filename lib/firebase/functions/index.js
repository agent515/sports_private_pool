                            ...
                            return admin.firestore().doc(`/contests/cricketMatchContest/cricketMatchContestCollection/${contestId}`).get()
                                .then((contestData) => {
                                    ...
                                    for (let key in contest['predictions']) {
                                        ...
                                        result[key] = parseFloat(matchResult['batting'][value['mostRuns']]['percentile']) + parseFloat(matchResult['bowling'][value['mostWickets']]['percentile']) + parseFloat(matchResult['mvp'][value['MVP']]['percentile']);
